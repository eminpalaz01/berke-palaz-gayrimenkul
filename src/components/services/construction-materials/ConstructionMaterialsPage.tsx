...
import { Building2, Truck, Shield, CheckCircle, Package, Wrench } from "lucide-react"
...
const materials = [
  ...
  },
  {
    ...
    icon: Shield,
    titleKey: "steel", 
    descriptionKey: "steelDesc"
  },
  {
    id: "brick",
    icon: Building2,
    titleKey: "brick",
    descriptionKey: "brickDesc"
  },
  {
    id: "insulation",
    icon: Wrench,
    titleKey: "insulation",
    descriptionKey: "insulationDesc"
  }
]
...
const features = [
  {
    ...
    descriptionKey: "qualityMaterialsDesc"
  },
  {
    id: "delivery",
    icon: Truck,
...
export function ConstructionMaterialsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-brand-concrete-50 dark:from-brand-concrete-900 dark:to-brand-concrete-800">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild size="lg" className="responsive-text-base">
                  <Link href="/contact">
                    {t('services.constructionMaterials.getQuote')}
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="responsive-text-base">
                  <Link href="/brands-we-represent">
                    {t('services.constructionMaterials.viewProducts')}
                  </Link>
                </Button>
              </div>
            </motion.div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3] sm:aspect-[3/2] lg:aspect-[4/3]">
                <Image
                  src="/images/services/construction-materials/construction-materials-facility.jpg"
                  alt={t('services.constructionMaterials.title')}
                  fill
      ...
      <section className="py-20 bg-white dark:bg-brand-concrete-800">
        <div className="container-custom">
          <AnimatedSectionHeader
            title={t('services.constructionMaterials.productCategories')}
            subtitle={t('services.constructionMaterials.productCategoriesSubtitle')}
                ...
                <Card className="h-full hover:shadow-lg transition-shadow duration-300 border-0 bg-gradient-to-br from-white to-brand-concrete-50 dark:from-brand-concrete-700 dark:to-brand-concrete-800">
                  <CardHeader className="text-center pb-4">
                    <div className="w-16 h-16 mx-auto mb-4 bg-brand-primary/10 dark:bg-brand-primary/20 rounded-full flex items-center justify-center">
                      <material.icon className="w-8 h-8 text-brand-primary" />
                    </div>
                    <CardTitle className="responsive-text-xl">
                      {t(`services.constructionMaterials.${material.titleKey}`)}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <CardDescription className="responsive-text-base text-center">
                      {t(`services.constructionMaterials.${material.descriptionKey}`)}
                    </CardDescription>
                  </CardContent>
                </Card>
              </motion.div>
      ...
      <section className="py-20 bg-brand-concrete-50 dark:bg-brand-concrete-900">
        <div className="container-custom">
          <AnimatedSectionHeader
            title={t('services.constructionMaterials.whyChooseUs')}
            subtitle={t('services.constructionMaterials.whyChooseUsSubtitle')}
            className="text-center mb-16"
          />
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="responsive-text-xl font-semibold mb-4 text-brand-concrete-900 dark:text-white">
                  {t(`services.constructionMaterials.${feature.titleKey}`)}
                </h3>
                <p className="responsive-text-base text-brand-concrete-600 dark:text-brand-concrete-300">
                  {t(`services.constructionMaterials.${feature.descriptionKey}`)}
                </p>
              </motion.div>
            ))}
          </div>
        ...
        <div className="container-custom text-center">
          ...
          >
            <h2 className="responsive-text-3xl lg:responsive-text-4xl font-bold text-white">
              {t('services.constructionMaterials.ctaTitle')}
            </h2>
            <p className="responsive-text-lg text-white/90">
              {t('services.constructionMaterials.ctaSubtitle')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" variant="secondary" className="responsive-text-base">
                <Link href="/contact">
                  {t('services.constructionMaterials.freeQuote')}
                </Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="responsive-text-base border-white hover:bg-white hover:text-brand-primary">
                <Link href="tel:+905466991701">
                  {t('services.constructionMaterials.callUs')}
                </Link>
              </Button>
            </div>
          </motion.div>
