...
import { Construction, Truck, Clock, Users, CheckCircle, Wrench } from "lucide-react"
...
const services = [
  {
    id: "concrete-pump",
    icon: Truck,
    titleKey: "concretePump",
    descriptionKey: "concretePumpDesc"
  },
  {
    id: "construction",
    icon: Construction,
    titleKey: "constructionWorks", 
    descriptionKey: "constructionWorksDesc"
  },
  {
...
const features = [
  {
    id: "experienced-team",
    icon: Users,
    titleKey: "experiencedTeam",
    descriptionKey: "experiencedTeamDesc"
  },
  {
    id: "modern-equipment",
    icon: Construction,
    titleKey: "modernEquipment",
    descriptionKey: "modernEquipmentDesc"
  },
  {
    id: "on-time-delivery",
    icon: Clock,
    titleKey: "onTimeDelivery",
    descriptionKey: "onTimeDeliveryDesc"
  }
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-brand-concrete-50 dark:from-brand-concrete-900 dark:to-brand-concrete-800">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild size="lg" className="responsive-text-base">
                  <Link href="/contact">
                    {t('services.constructionServices.getQuote')}
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="responsive-text-base">
                  <Link href="/projects">
                    {t('services.constructionServices.viewProjects')}
                  </Link>
                </Button>
              </div>
            </motion.div>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3] sm:aspect-[3/2] lg:aspect-[4/3]">
                <Image
                  src="/images/services/construction/construction-project.jpg"
                  alt={t('services.constructionServices.title')}
                  fill
      ...
      <section className="py-20 bg-white dark:bg-brand-concrete-800">
        <div className="container-custom">
          <AnimatedSectionHeader
            title={t('services.constructionServices.serviceAreas')}
            subtitle={t('services.constructionServices.serviceAreasSubtitle')}
              ...
              >
                <Card className="h-full hover:shadow-lg transition-shadow duration-300 border-0 bg-gradient-to-br from-white to-brand-concrete-50 dark:from-brand-concrete-700 dark:to-brand-concrete-800">
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="responsive-text-xl">
                      {t(`services.constructionServices.${service.titleKey}`)}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <CardDescription className="responsive-text-base text-center">
                      {t(`services.constructionServices.${service.descriptionKey}`)}
                    </CardDescription>
                  </CardContent>
                </Card>
              </motion.div>
      ...
      <section className="py-20 bg-brand-concrete-50 dark:bg-brand-concrete-900">
        <div className="container-custom">
          <AnimatedSectionHeader
            title={t('services.constructionServices.whySelale')}
            subtitle={t('services.constructionServices.whySelaleSubtitle')}
            className="text-center mb-16"
          />
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="responsive-text-xl font-semibold mb-4 text-brand-concrete-900 dark:text-white">
                  {t(`services.constructionServices.${feature.titleKey}`)}
                </h3>
                <p className="responsive-text-base text-brand-concrete-600 dark:text-brand-concrete-300">
                  {t(`services.constructionServices.${feature.descriptionKey}`)}
                </p>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-20 bg-white dark:bg-brand-concrete-800">
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: "200+", labelKey: "completedProjects" },
              { value: "30", labelKey: "yearsExperience" },
              { value: "6", labelKey: "concretePumps" },
              { value: "150+", labelKey: "expertStaff" }
            ].map((stat, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 50 }}
                ...
                className="text-center"
              >
                <div className="responsive-text-3xl lg:responsive-text-4xl font-bold text-brand-primary mb-2">
                  {stat.value}
                </div>
                <div className="responsive-text-base text-brand-concrete-600 dark:text-brand-concrete-300">
                  {t(`services.constructionServices.${stat.labelKey}`)}
                </div>
              </motion.div>
            ))}
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild size="lg" variant="outline" className="responsive-text-base border-white hover:bg-white hover:text-brand-primary">
                <Link href="tel:+905466991701">
                  {t('services.constructionServices.callNow')}
                </Link>
              </Button>
            </div>
          </motion.div>
